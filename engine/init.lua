...
engine.drawableImage = require(ENGINE_PATH.."/drawableImage")
engine.drawableTileset = require(ENGINE_PATH.."/drawableTileset")
engine.drawableFont = require(ENGINE_PATH.."/drawableFont")
